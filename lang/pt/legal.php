...
return [
    ...
    'privacy' => [
        ...
        'contact_data' => 'Dados de Contacto',
        ...
        'exercise_rights_text' => 'Para exercer qualquer destes direitos, contacte-nos atraves do email configurado ou por correio para a morada indicada.',
        ...
        'cookies' => 'Cookies',
        'cookies_text' => 'Este Portal utiliza cookies para melhorar a experiencia do utilizador e garantir o funcionamento adequado dos servicos. Para mais informacoes sobre os cookies utilizados, consulte a nossa Politica de Cookies.',
    ...
    'terms' => [
        ...
        'general_provisions_text' => "Os presentes Termos de Uso regulam o acesso e utilizacao do {$portalName}, operado por {$federationName} ({$federationShortName}). Ao aceder e utilizar este Portal, o utilizador aceita estes Termos de Uso.",
        ...
        // Public disclosure of professional members
        'public_disclosure' => 'Publicacao de Dados de Membros Profissionais',
        'public_disclosure_intro' => "Ao adquirir uma licenca ou certificacao profissional, o utilizador reconhece que a {$federationShortName} pode publicar em paginas publicas do Portal dados selecionados necessarios para verificacao publica:",
        'public_disclosure_photo' => 'Fotografia',
        'public_disclosure_name' => 'Nome completo',
        'public_disclosure_birth_date' => 'Data de nascimento',
        ...
        'user_obligations' => 'Obrigacoes do Utilizador',
        'user_obligations_intro' => 'O utilizador compromete-se a:',
        ...
        'intellectual_property_license' => 'E concedida ao utilizador uma licenca limitada, nao exclusiva e nao transferivel para aceder e utilizar o Portal para fins pessoais e nao comerciais, desde que respeite estes Termos de Uso.',
        ...
        'indemnification_text' => "O utilizador compromete-se a indemnizar e isentar a {$federationShortName}, os seus dirigentes, colaboradores e representantes de quaisquer reclamacoes, danos, perdas ou despesas resultantes da violacao destes Termos ou da utilizacao indevida do Portal.",
        ...
        'suspension_termination_intro' => "A {$federationShortName} pode suspender ou cessar o acesso de qualquer utilizador ao Portal, sem aviso previo, nas seguintes situacoes:",
        'suspension_terms_violation' => 'Violacao destes Termos de Uso',
        'suspension_illegal_acts' => 'Pratica de atos ilicitos',
        'suspension_harmful_conduct' => "Condutas que prejudiquem a {$federationShortName} ou outros utilizadores",
        'suspension_user_request' => 'A pedido do proprio utilizador',
        ...
        'dispute_resolution_text' => 'Em caso de litigio, as partes comprometem-se a procurar uma solucao amigavel antes de recorrer aos tribunais. O utilizador pode recorrer aos mecanismos de resolucao alternativa de litigios disponiveis, incluindo a plataforma europeia de resolucao de litigios em linha (https://ec.europa.eu/consumers/odr).',

...
return [
    ...
    'registration_title' => 'Registro de Conta Individual',
    ...
    'submit_registration' => 'Submeter registro',

    // Document type options
    'doc_types' => [
        'identity_card' => 'Carteira de Identidade',
        'citizen_card' => 'Carteira de Motorista',
        'foreign_identity_card' => 'Carteira de Identidade Estrangeira',
        'permanent_residence_card' => 'Visto de Residência Permanente',
        'passport' => 'Passaporte',
    ],

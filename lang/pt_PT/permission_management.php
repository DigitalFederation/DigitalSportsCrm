...
return [
    ...
    'name_help' => 'Use minúsculas com hífens (ex: gerir-utilizadores)',
    ...
    // Import/Export
    'select_file' => 'Selecionar Ficheiro CSV',
    ...
    'affected_users' => 'Utilizadores Afetados',
    ...
    'validation' => [
        ...
        'name_format' => 'O nome da permissão deve ser em minúsculas com hífens (ex: gerir-utilizadores).',
    ...
    // Help text
    'help' => [
        'naming_convention' => 'Use letras minúsculas com hífens entre palavras (ex: gerir-utilizadores, ver-relatórios)',
        'categories' => 'As categorias ajudam a organizar permissões. Categorias comuns: Utilizadores, Funções, Conteúdo, Definições, Relatórios',

...
return [
    'currency_unsupported' => 'Não suporta :currency',
    'currency_unsupported_hint' => 'Este gateway não cobra em :currency, a moeda da instalação. Está oculto no checkout.',
    // Page titles
    ...
    // Form labels
    'instructions_help' => 'Instruções mostradas aos utilizadores ao selecionar este metodo de pagamento.',
    'enabled' => 'Ativo',
    'disabled' => 'Inativo',

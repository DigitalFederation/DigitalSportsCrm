...
/**
 * Seeds Brazilian municipalities as districts using their 7-digit IBGE code.
 *
 ...
 * - the database-specific IDs from the SQL dump are deliberately ignored.
 */
class BrazilDistrictSeeder extends Seeder
{
    ...
    public static function data(): array
    {
        return [
            ...
            ['code' => '2922250', 'name' => 'Muquém do São Francisco'],
            ...
            ['code' => '2928505', 'name' => 'Santa Terezinha'],
            ...
            ['code' => '3200706', 'name' => 'Atílio Vivácqua'],
            ...
            ['code' => '5220157', 'name' => 'São Luiz do Norte'],
            ...
            ['code' => '3105509', 'name' => 'Barão do Monte Alto'],
            ...
            ['code' => '3122900', 'name' => 'Dona Euzébia'],
            ...
            ['code' => '3165206', 'name' => 'São Tomé das Letras'],
            ...
            ['code' => '5101837', 'name' => 'Boa Esperança do Norte'],
            ...
            ['code' => '5107800', 'name' => 'Santo Antônio de Leverger'],
            ...
            ['code' => '1502954', 'name' => 'Eldorado do Carajás'],
            ...
            ['code' => '1506500', 'name' => 'Santa Izabel do Pará'],
            ...
            ['code' => '2513653', 'name' => 'Joca Claudino'],
            ...
            ['code' => '2513968', 'name' => 'São Domingos'],
            ...
            ['code' => '2515401', 'name' => 'São Vicente do Seridó'],
            ['code' => '2516409', 'name' => 'Tacima'],
            ...
            ['code' => '2601607', 'name' => 'Belém do São Francisco'],
            ...
            ['code' => '2608503', 'name' => 'Lagoa de Itaenga'],
            ...
            ['code' => '2613800', 'name' => 'São Vicente Férrer'],
            ...
            ['code' => '3305901', 'name' => 'Trajano de Moraes'],
            ...
            ['code' => '2401206', 'name' => 'Arez'],
            ['code' => '2400208', 'name' => 'Assú'],
            ...
            ['code' => '2401305', 'name' => 'Campo Grande'],
            ...
            ['code' => '2410306', 'name' => 'Serra Caiada'],
            ...
            ['code' => '1400605', 'name' => 'São Luiz do Anauá'],
            ...
            ['code' => '4315503', 'name' => 'Restinga Sêca'],
            ...
            ['code' => '4317103', 'name' => 'Sant\'Ana do Livramento'],
            ...
            ['code' => '4322855', 'name' => 'Vespasiano Corrêa'],
            ...
            ['code' => '2800100', 'name' => 'Amparo do São Francisco'],
            ...
            ['code' => '2802601', 'name' => 'Graccho Cardoso'],
            ...
            ['code' => '3515004', 'name' => 'Embu das Artes'],
            ...
            ['code' => '3550001', 'name' => 'São Luiz do Paraitinga'],
            ...
            ['code' => '1706001', 'name' => 'Couto Magalhães'],
            ...
            ['code' => '1720499', 'name' => 'São Valério'],
            ['code' => '1720804', 'name' => 'Sítio Novo do Tocantins'],
            ['code' => '1708254', 'name' => 'Tabocão'],
    ...
    public function run(): void
    {
        ...
        if (! $brasil) {
            $this->command?->warn('BrazilDistrictSeeder: country BRA was not found. Nothing was inserted.');
        ...
        DB::transaction(function () use ($brasil, $now, &$inserted, &$preserved, &$nameConflicts, &$countryConflicts): void {
            foreach (array_chunk(static::data(), self::CHUNK_SIZE) as $districts) {
                $codes = array_column($districts, 'code');

                $existing = District::query()
                    ->whereIn('code', $codes)
                    ->get(['code', 'name', 'country_id'])
                    ->keyBy('code');

                $rows = [];

                foreach ($districts as $district) {
                    $current = $existing->get($district['code']);

                    if ($current) {
                        $preserved++;

                        if ($current->name !== $district['name']) {
                            $nameConflicts++;
                        }

                        if ((string) $current->country_id !== (string) $brasil->id) {
                            $countryConflicts++;
                        }
        ...
        $this->command?->info("BrazilDistrictSeeder: {$inserted} inserted; {$preserved} existing rows preserved.");

        if ($nameConflicts > 0) {
            $this->command?->warn("BrazilDistrictSeeder: {$nameConflicts} existing district(s) have a different name and were intentionally left unchanged.");
        }

        if ($countryConflicts > 0) {
            $this->command?->warn("BrazilDistrictSeeder: {$countryConflicts} existing district(s) with a Brazilian IBGE code point to another country (or NULL) and were intentionally left unchanged.");
        }
    }
}

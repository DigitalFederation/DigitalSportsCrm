...
class RefereeEnrollmentFactory extends Factory
{
    protected $model = RefereeEnrollment::class;
    ...
    {
        return $this->withStatus(\Domain\EvtEvents\States\CanceledRefereeEnrollmentState::class);
    }

    public function pending(): static
    {
        return $this->withStatus(\Domain\EvtEvents\States\PendingRefereeEnrollmentState::class);
    }
}

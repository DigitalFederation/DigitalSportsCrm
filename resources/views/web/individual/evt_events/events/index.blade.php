    ...
    <div class="previous-layout-classes">
        ...
        <div class="mb-6">
            <div class="flex gap-2">
                <a href="{{ route('individual.evt-events.competitions.index') }}"
        ...
        <!-- Filters -->
        <div class="mb-6 card">
            <form action="{{ route('individual.evt-events.events.index') }}" method="GET" class="space-y-4">
                ...
                @foreach($events as $event)
                    <tr class="hover:bg-gray-50" wire:key="event-{{ $event->id }}">
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap text-right">
                            <a href="{{ route('individual.evt-events.events.show', $event->id) }}" class="btn btn-secondary btn-sm">{{ __('common.view') }}</a>
                        </td>
                    </tr>
                @endforeach
            </x-dynamic-table>

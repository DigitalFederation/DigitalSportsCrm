<x-layout>
    <div class="min-h-screen"
        ...
        <!-- Existing header and filter code remains the same -->
                ...
                <div class="flex md:items-center md:justify-between">
                    <div class="flex-1 min-w-0">
                        <h1 class="text-2xl font-bold text-gray-900 mb-1">
                            {{ __('certification_card.my_certifications') }}
                        </h1>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open"
                                ...
                                <form action="{{ request()->url() }}" method="get" class="p-4">
                                    {{-- Committee Filter removed - National certifications only show SPORT committee --}}
                                    <div class="space-y-4">
                                        {{-- Category Filter --}}
                                        <div>
                                            <label
            ...
            <div class="space-y-12">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    @foreach($certifications as $certification)
                                        <div class="group relative block"
                                             @click="window.innerWidth < 768 ? openModal($event, {{ json_encode($certification) }}) : window.location.href='{{ route('individual.certification-attributed.show', $certification->id) }}'">
                                            ...
                                            <div
                                                ...
                                                <div class="relative rounded-xl overflow-hidden shadow-lg">
                                                    ...
                                                    <div id="card-front-{{ $certification->id }}"
                                                         class="aspect-[1.586/1] relative"> {{-- This aspect ratio is common for ID cards --}}
                ...
                @empty
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('certification_card.no_certifications') }}</h3>
                        <p class="mt-1 text-sm text-gray-500">{{ __('certification_card.no_certifications_message') }}</p>
                    </div>
                @endforelse
            </div>
        </div>
            ...
            <div x-show="showModal"
             ...
             "
                    ...
                    <div class="px-4 pb-8 space-y-6">
                        ...
                        <!-- View Details Button -->
                        <template x-if="selectedCard">
                            <a :href="`/individual/certification-attributed/${selectedCard.id}`"

                                ...
                                <template x-if="detailType === 'insurance'">
                                    <div class="bg-slate-50 px-4 py-3 rounded-md">
                                        ...
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="text-slate-900" x-text="detailFee + ' {{ \Support\Money::code() }}'"></span>
                                        </div>
                                    </div>
                                </template>
                                    ...
                                    <div>
                                            ...
                                            <template x-for="plan in detailPlans" :key="plan.id">
                                                <div class="border border-slate-200 rounded-lg p-4">
                                                    <div class="flex justify-between items-start mb-2">
                                                        ...
                                                        <span class="text-sm font-medium text-blue-600" x-text="(plan.individual_fee || 0).toFixed(2) + ' {{ \Support\Money::code() }}'"></span>
                                                    </div>
                                        ...
                                        <div class="bg-slate-50 px-4 py-3 rounded-md">
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="text-2xl font-bold text-blue-600" x-text="detailPrice + ' {{ \Support\Money::code() }}'"></span>
                                            </div>

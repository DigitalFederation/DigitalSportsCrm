            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <dl class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm font-semibold text-gray-900">{{ money($transaction->amount) }}</dd>
                    </div>
                    <div class="flex justify-between">
                ...
                @if($transaction->document)
                    <dl class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm font-semibold text-gray-900">{{ money($transaction->document->total_value) }}</dd>
                        </div>

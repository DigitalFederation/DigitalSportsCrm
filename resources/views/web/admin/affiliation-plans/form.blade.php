<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="flex gap-x-2">
        <div class="md:w-1/3">
            <label for="individual_fee" class="block text-sm font-medium text-gray-700">{{ __('Individual Fee') }}({{ \Support\Money::symbol() }})</label>
        ...
        <div class="md:w-1/3">
            <label for="entity_fee" class="block text-sm font-medium text-gray-700">{{ __('Entity Fee') }}({{ \Support\Money::symbol() }})</label>

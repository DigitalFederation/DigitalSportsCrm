        ...
        <div class="space-y-6" x-data="{ loaded: false }" x-init="setTimeout(() => loaded = true, 100)">
                ...
                <div class="px-6 py-6 sm:px-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <h1 class="text-xl sm:text-2xl font-semibold text-green-600">{{ __('events.admin_coach_enrollments_history_title') }}</h1>
                            <p class="mt-1 text-gray-500 text-sm">{{ __('events.admin_coach_enrollments_history_description') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden"
                ...
                <div class="p-4 sm:p-6 overflow-x-auto">
                    @livewire('admin.evt-events.coach-enrollments-history-table')
                </div>
            </div>

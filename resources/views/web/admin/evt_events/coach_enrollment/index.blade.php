        ...
        <x-layout.page-header
            ...
            :actions="[
                ...
                [
                    ...
                    'url' => route('admin.evt-events.events.enrollments.coach.export', $event->id),
                    'text' => __('events.export_enrollment'),
                ],
            ]"
        />

        <x-evt_event.enrollment-navigation :event="$event" active="coach.index" />

        <x-filter-form :post="route('admin.evt-events.events.enrollments.coach.index', $event->id)">

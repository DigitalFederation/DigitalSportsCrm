<x-layout>
    ...
    <div class="card w-full overflow-hidden">
        <div class="card-body">
            <form
                action="{{ route('federation.certification-attributed.update', $certificationAttributed->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="national_code" class="block text-sm font-medium text-gray-700">National
                    ...
                    <!-- Issue Date -->
                    <div>
                        <label for="current_term_starts_at" class="block text-sm font-medium text-gray-700">Issue
                            Date</label>
                    ...
                    <!-- Expire Date -->
                    <div>
                        <label for="current_term_ends_at" class="block text-sm font-medium text-gray-700">
                            Expire Date</label>
                ...
                <div class="mt-4 flex justify-start">
                    <x-forms.card-form-submit backRoute="federation.certification-attributed.index"
                                              :buttonText="__('Save Changes')"></x-forms.card-form-submit>
                </div>
            </form>
        </div>
    </div>

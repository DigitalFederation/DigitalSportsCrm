...
<x-layout>
    ...
    <div class="previous-layout-classes">
        @php
            $actions = [
                ...
                [
                    ...
                    'url' => route('federation.evt-events.events.referee-enrollment.create', $event->id),
        ...
        <x-filter-form :post="route('federation.evt-events.events.referee-enrollment.index', $event->id)">
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px !bg-slate-50">
                                <div class="flex flex-row items-center gap-2">
                                    <form
                                        action="{{ route('federation.evt-events.events.referee-enrollment.destroy', ['event' => $event->id, 'referee_enrollment' => $enrollment->id]) }}"
                                        method="POST" x-data="{}"

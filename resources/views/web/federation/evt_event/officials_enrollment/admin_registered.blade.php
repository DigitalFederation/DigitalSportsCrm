        ...
        <x-layout.page-header
            ...
            :actions="[
                [
                    'type' => 'link',
                    'class' => 'btn btn-info',
                    'url' => route('federation.evt-events.events.officials-enrollment.index', $event->id),
                    'text' => __('events.back_to_enrollments'),
                ],
            ]"
        />

        <x-evt_event.enrollment-navigation :event="$event" active="official.registered" :links="$navigationLinks" />

        <x-filter-form :post="route('federation.evt-events.events.officials-enrollment.registered', $event->id)">

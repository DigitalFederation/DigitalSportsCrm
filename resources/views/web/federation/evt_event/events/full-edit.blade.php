    ...
    <div class="previous-layout-classes">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5 mt-5">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <a href="{{ route('federation.evt-events.events.show', $event->id) }}" class="btn btn-secondary">
        ...
        <form action="{{ route('federation.evt-events.events.update', $event->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')

@section('title', __('events.coach_enrollment'))

<x-layout>
    <x-evt_event.sticky-table-styles />
    <div class="previous-layout-classes">
        <x-layout.page-header
            :title="__('events.coach_enrollment')"
            :subtitle="$event->name"
            :actions="[
                [
                    'type' => 'link',
        ...
        <x-evt_event.enrollment-navigation :event="$event" active="coach.index" :links="$navigationLinks" />

        <x-filter-form :post="route('federation.evt-events.events.coach-enrollment.index', $event->id)">

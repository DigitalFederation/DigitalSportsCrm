@section('title', __('admin.entity_international_certifications'))
<x-layout>
    <div class="previous-layout-classes">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="page-first-title">{{ __('admin.entity_international_certifications') }}</h1>
                <p class="text-slate-600 dark:text-slate-400">{{ __('admin.view_members_international_certifications') }}</p>
            </div>
        </div>

        <x-information-box
            :title="__('admin.information')"
            :body="__('admin.entity_certifications_information')" />
        ...
        @else
            <div class="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-8 text-center">
                ...
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">{{ __('admin.no_entity_certifications_description') }}</p>
            </div>
        @endif

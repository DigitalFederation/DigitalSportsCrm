@section('title', __('admin.my_international_certifications'))
<x-layout>
    <div class="previous-layout-classes">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="page-first-title">{{ __('admin.my_international_certifications') }}</h1>
                <p class="text-slate-600 dark:text-slate-400">{{ __('admin.view_international_certifications') }}</p>
            </div>
        </div>

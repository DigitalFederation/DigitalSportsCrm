<div x-data="{ showModal: false,  isLoading: false, animation: '{{ $animation }}' }"
     @keydown.escape.window="showModal = false"
     @closeModal.window="showModal = false">

    <div x-on:click="showModal = true" class="flex flex-row gap-x-1 cursor-pointer {{ $buttonClass }}">
    ...
    {{-- x-teleport requires a single root element --}}
    <template x-teleport="body">
        ...
        <div
            ...
            class="fixed inset-0 bg-slate-900/75 z-50"
        ...
        <div
            ...
            x-show="showModal"
            :class="animation"
            class="fixed md:top-10 left-0 right-0 z-50 w-full overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full md:pl-36">

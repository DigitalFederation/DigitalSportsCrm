        ...
        <table class="table table_list w-full">
            ...
            @foreach($document->details as $detail)
                <tr class="border-b-slate-200 border-b">
                    ...
                    <td class="py-3 text-right">{{ money($detail->unit_value) }}</td>
                    <td class="py-3 text-right font-bold">{{ money($detail->total_value) }}</td>
                </tr>
            @endforeach
            </tbody>
            <tfooter>

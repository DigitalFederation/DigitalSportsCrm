...
<!-- resources/views/components/entity-individual-selector.blade.php -->
<div
    x-data="{
        openModal() {
            Livewire.dispatch('open-entity-modal-{{ $inputId }}');
        }
    }"
    ...
    <livewire:entity-individual-selector-modal :entity-id="$entityId"
                                              :input-id="$inputId"
                                              :wire:key="'entity-modal-' . $inputId" />

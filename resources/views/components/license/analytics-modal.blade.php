                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-2xl font-bold text-green-600">{{ money($analyticsData['total_revenue'] ?? 0, 0) }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-2xl font-bold text-amber-600">{{ money($analyticsData['avg_license_value'] ?? 0, 0) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($analyticsData['top_licenses'] as $license)
                                            <tr>
                                                ...
                                                <td class="px-3 py-2 text-sm text-gray-900">{{ money($license['revenue'] ?? 0, 0) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>

                ...
                <div class="p-6 space-y-6">
                    ...
                    <section>
                        ...
                        <div
                            ...
                            <div>
                                <label class="block text-sm font-medium mb-1"
                                       for="unit_value_individual"> {{ __('Preço para Individual (:currency)', ['currency' => \Support\Money::symbol()]) }}</label>
                                <input type="text"
                            ...
                            <div>
                                <label class="block text-sm font-medium mb-1"
                                       for="unit_value_entity"> {{ __('Preço para Entidade (:currency)', ['currency' => \Support\Money::symbol()]) }}</label>
                                <input type="text"
                            ...
                            <div>
                                <label class="block text-sm font-medium mb-1"
                                       for="unit_value_federation"> {{ __('Preço para Federação (:currency)', ['currency' => \Support\Money::symbol()]) }}</label>
                                <input type="text"

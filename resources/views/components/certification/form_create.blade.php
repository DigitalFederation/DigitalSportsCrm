    ...
    <div class="p-6 space-y-8">
        ...
        <div x-show="activeTab === 'pricing'" x-cloak x-transition.opacity class="space-y-8">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-medium mb-1" for="digital_price">{{ __('certifications.form.fields.digital_price') }} ({{ \Support\Money::symbol() }})</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1" for="digital_plus_card_price">{{ __('certifications.form.fields.digital_plus_card_price') }} ({{ \Support\Money::symbol() }})</label>

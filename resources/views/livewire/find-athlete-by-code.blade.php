    ...
    <section>
        ...
        <div class="mt-4">
            ...
            <div class="flex items-end">
                <input wire:model.live="athleteCode" type="text" class="w-full form-input rounded-r-none" name="athlete" id="find_athlete_member_code" {{ $entityId === null ? 'disabled' : '' }}>
                <x-entity-individual-selector :entity-id="$entityId" inputId="find_athlete_member_code" wireModel="athleteCode" />
            </div>

<div>
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <h1 class="page-first-title">{{ __('federation.create_entity_insurance') }}</h1>
        ...
        <div class="information-box mt-4">
            <div class="flex items-center">
                ...
                <span class="text-sm text-blue-800">
                    {{ __('federation.entity_insurance_creation_info') }}
                </span>
            </div>
        </div>
    </div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button
                    ...
                    @class([
                        ...
                        'bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500' => $hasValidationPlanPrivileges,
                        'bg-gray-300 cursor-not-allowed' => !$hasValidationPlanPrivileges,
                    ])
                    @disabled(!$hasValidationPlanPrivileges)
                >
                    {{ __('federation.actions_buttons.create_insurance') }}
                </button>
            </div>
        @endif
    @endif

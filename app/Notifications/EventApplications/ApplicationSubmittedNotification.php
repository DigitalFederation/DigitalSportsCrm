...
class ApplicationSubmittedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('event_applications.notifications.submitted.subject'))
            ->markdown('emails.event-applications.application-submitted', [
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'reference_number' => $this->application->id,
            'status' => $this->application->status_class,
            'message' => __('event_applications.notifications.submitted.message'),
            'url' => $this->getEntityUrl(),
        ];
    }

...
class ApplicationReturnedForCorrectionNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('event_applications.notifications.returned.subject'))
            ->markdown('emails.event-applications.application-returned', [
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => __('event_applications.notifications.returned.message'),
            'url' => $this->getEntityUrl(),
        ];
    }
    ...
    protected function getEntityUrl(): string
    {
        ...
        return route("{$entityType}.event-applications.edit", $this->application->id);
    }
}

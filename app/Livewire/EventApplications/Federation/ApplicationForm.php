...
class ApplicationForm extends Component
{
    ...
    public function saveDraft(): void
    {
        ...
        try {
            ...
            $data = $this->getFormData($federation);
            ...
            if ($this->mode === 'edit' && $this->application) {
                ...
                if ($this->template) {
                    ...
                    $duplicate = $checkDuplicate->execute($federation->id, $this->template->id);
            ...
            $this->redirect(route('federation.event-applications.show', $application), navigate: true);
    ...
    {
        $this->redirect(route('federation.event-applications.index'), navigate: true);
    }

    protected function getFormData(Federation $federation): array
    {
        return [
    ...
    {
        return view('livewire.event-applications.federation.application-form');
    }
}

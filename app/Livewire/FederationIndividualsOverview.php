 ...
 * Dashboard widget.
 */
class FederationIndividualsOverview extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        if ($federationId) {
            // Cache keys
            $totalIndividualCacheKey = "total_individual_count_federation_{$federationId}";
            $totalEntityCacheKey = "total_entity_count_federation_{$federationId}";

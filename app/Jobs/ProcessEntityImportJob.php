...
use Domain\Imports\Actions\ProcessEntityImportChunkAction;
...
class ProcessEntityImportJob implements ShouldQueue
{
     ...
     * Execute the job.
     */
    public function handle(ProcessEntityImportChunkAction $processChunkAction): void
    {
    ...
    {
        Log::error('Entity import chunk job failed', [

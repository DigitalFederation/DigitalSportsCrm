...
class CertificationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'unit_value' => 'nullable|numeric|min:0|max:9999.99',
            'unit_value_individual' => 'nullable|numeric|min:0|max:9999.99',
            'unit_value_entity' => 'nullable|numeric|min:0|max:9999.99',
            'tax_value' => 'nullable|numeric|min:0|max:999.99',
            'tax_percentage' => 'nullable|numeric|min:0|max:100',
            'moloni_reference' => 'nullable|string|max:50',
            // New pricing fields
            'digital_price' => 'nullable|numeric|min:0|max:9999.99',
            'digital_plus_card_price' => 'nullable|numeric|min:0|max:9999.99',

...
class InsurancePlanCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'individual_fee' => ['required_without:entity_fee', 'nullable', 'numeric', 'min:0', new \App\Rules\CurrencyScale],
            'entity_fee' => ['required_without:individual_fee', 'nullable', 'numeric', 'min:0', new \App\Rules\CurrencyScale],
